...
public class UserMessageCodec{
    ...
    static public class CourseSelect implements MessageCodec<SelectCourseMessage, SelectCourseMessage> {
        /**
         * 将消息实体封装到Buffer用于传输
         * 
         * 实现方式：
         ...
         */
        @Override
        public void encodeToWire(Buffer buffer, SelectCourseMessage s) {
            final ByteArrayOutputStream b = new ByteArrayOutputStream();
            ObjectOutputStream o;
            try {
                o = new ObjectOutputStream(b);
         ...
         */
        @Override
        public SelectCourseMessage transform(SelectCourseMessage s) {
            return s;
        }
        /**
         * 编解码器的名称：
